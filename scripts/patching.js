...
export function registerWalledTemplates() {
  ...
  libWrapper.register(MODULE_ID, "MeasuredTemplate.prototype.draw", walledTemplatesMeasuredTemplateDraw, "WRAPPER");
}

async function walledTemplatesMeasuredTemplateDraw(wrapped) {
  log("Initiated MeasuredTemplate.prototype.draw");
  wrapped();
}
